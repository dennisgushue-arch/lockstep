        ...
        <Card>
          ...
          <CardContent>
            <ul className="space-y-2 text-sm font-mono">
              <li className="flex justify-between"><span>SUPABASE_URL</span> <Badge variant="outline">MOCKED</Badge></li>
              <li className="flex justify-between"><span>STRIPE_SECRET</span> <Badge variant="outline">MOCKED</Badge></li>
              <li className="flex justify-between"><span>OPENAI_API_KEY</span> <Badge variant="outline">MOCKED</Badge></li>
